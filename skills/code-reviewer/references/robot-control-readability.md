...
- [C++ Style And Documentation](#c-style-and-documentation)
- [Control Code Readability](#control-code-readability)
- [Keep The Mathematical Flow Visible](#keep-the-mathematical-flow-visible)
- [Helper Policy](#helper-policy)
- [Abstraction Level And Naming Strictness](#abstraction-level-and-naming-strictness)
- [Function Naming Conventions](#function-naming-conventions)
- [Output Parameters And Mutation Clarity](#output-parameters-and-mutation-clarity)
- [Per-Step Memory And Workspace Policy](#per-step-memory-and-workspace-policy)
- [Private Member Workspace Policy](#private-member-workspace-policy)
- [Utility Package Policy](#utility-package-policy)
...
```cpp
// Non-real-time adapter boundary when no framework primitive owns transfer.
